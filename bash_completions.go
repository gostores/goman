...
const (
	BashCompFilenameExt     = "goman_annotation_bash_completion_filename_extensions"
	BashCompCustom          = "goman_annotation_bash_completion_custom"
	BashCompOneRequiredFlag = "goman_annotation_bash_completion_one_required_flag"
	BashCompSubdirsInDir    = "goman_annotation_bash_completion_subdirs_in_dir"
)
