...
func TestGenManSeeAlso(t *testing.T) {
	rootCmd := &goman.Command{Use: "root", Run: emptyRun}
	aCmd := &goman.Command{Use: "aaa", Run: emptyRun, Hidden: true} // #229
	bCmd := &goman.Command{Use: "bbb", Run: emptyRun}
	cCmd := &goman.Command{Use: "ccc", Run: emptyRun}
...
func TestGenManTree(t *testing.T) {
	c := &goman.Command{Use: "do [OPTIONS] arg1 arg2"}
