...
func GenReST(cmd *goman.Command, w io.Writer) error {
	return GenReSTCustom(cmd, w, defaultLinkHandler)
}

// GenReSTCustom creates custom reStructured Text output.
func GenReSTCustom(cmd *goman.Command, w io.Writer, linkHandler func(string, string) string) error {
...
func GenReSTTree(cmd *goman.Command, dir string) error {
...
func GenReSTTreeCustom(cmd *goman.Command, dir string, filePrepender func(string) string, linkHandler func(string, string) string) error {
